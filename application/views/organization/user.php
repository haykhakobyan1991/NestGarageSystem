...
<div
	...
	<div
		...
		<div
			class="jumbotron jumbotron-fluid pb-2 pt-2">
			<div
				...
				<div
					...
					<div
						class="col-sm-6">
						<img
							style="-webkit-border-radius: 50%;-moz-border-radius: 50%;border-radius: 50%;width: 50px"
		...
		<div
			class="modal fade add_user_modal"
			tabindex="-1"
			role="dialog"
			aria-labelledby="myLargeModalLabel"
			aria-hidden="true">
				...
				<div
					...
					<form
						...
						<div
									...
									<div
										...
										<div
											...
											<div
												class="col-sm-1"></div>
											<label
												class="col-sm-2 col-form-label"><?= lang('first_name') ?>
												*</label>
											<div
												class="col-sm-7">
												<input
										...
										<div
											...
											<div
												class="col-sm-1"></div>
											<label
												class="col-sm-2 col-form-label"><?= lang('last_name') ?>
												*</label>
											<div
												class="col-sm-7">
												<input
										...
										<div
											...
											<div
												class="col-sm-1"></div>
											<label
												class="col-sm-2 col-form-label"><?= lang('email') ?>
												*</label>
											<div
												class="col-sm-7">
												<input
										...
										<div
											...
											<div
												class="col-sm-1"></div>
											<label
												class="col-sm-2 col-form-label"><?= lang('login') ?>
												*</label>
											<div
												class="col-sm-7">
												<input
										...
										<div
											...
											<div
												class="col-sm-1"></div>
											<label
												class="col-sm-2 col-form-label"><?= lang('password') ?>
												*</label>
											<div
												class="col-sm-7">
												<input
												...
												<button
													type="button"
													class="btn float-left  btn-sm btn-outline-secondary  ml-3 hide_password"
												...
												<button
													...
													type="button"
													class="save_cancel_btn btn btn-success ml-3 float-right"
										...
										<div
											...
											<div
												class="col-sm-1"></div>
											<label
												class="col-sm-2 col-form-label"><?= lang('type') ?></label>
											<div
												class="col-sm-7">
												<select
													name="role"
							...
							<div
								class="modal-footer pb-0 col-sm-12"
								style="padding-right: 141px !important;">
								<button
									id="add_user"
									type="button"
								...
								<button
									id="load"
									style="height: 40px !important; width: 93px !important;"
			...
			<div
					...
					<div
						...
						<div
							...
							<p class="display-5 font-weight-bold float-left"
							   style="font-size: 13px;"><?= lang('total_user') ?></p>
							<span
				...
				<div
					...
					<span
						...
						data-toggle="modal"
						data-target=".add_user_modal"><?= lang('add_user') ?>
				</div>
			</div>
			<hr class="my-2">
		</div>
			...
			<div
				...
				<table
					...
					<tr>
						...
						<th style="font-size: 12px !important;font-weight: 500;"><?= lang('login') ?>
							․
						</th>
							...
							<td>
								<div
									...
									<div
										...
										<?= $row['user_name'] ?>
										<small
											class="email_addres form-text text-muted">
											<?= $row['email'] ?>
										</small>
									</div>
								</div>
