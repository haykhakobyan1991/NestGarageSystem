		...
		<div
			...
			<table
				...
				<tr>
					...
					<th class="table_th"
						style="min-width: 150px;"><?= lang('new_used') ?></th>
					<th class="table_th"
						style="min-width: 150px;"><?= lang('type_disc_biblical') ?></th>
				...
				<? } else { ?>
						<span
							class="ex_9_add_new_tr btn btn-outline-secondary btn-sm "
							data-id="ex_9"
							style="padding: .25rem .5rem !important;">
				<? } ?>
				...
				if ($fleet_data) {
					foreach ($fleet_data as $row) {
						...
						<tr style="height: 40px;">
							...
							<td class="border">
								<?= ($row['brake_type'] == 1 ? lang('disc') : lang('biblical')) ?>
							</td>
							<td class="border">
								<?= $row['count'] ?>
							</td>
				...
				<tr>
					...
					<td class="border">
						<select
							...
							title="<?= lang('new_used') ?>">
							<option
								value="1"><?= lang('new') ?></option>
							<option
								value="2>"><?= lang('used') ?></option>
						</select>
					</td>
					<td class="border">
						<select
							...
							data-size="5"
							name="brake_type[1]"
							title="<?= lang('type_disc_biblical') ?>">
							<option
								value="1"><?= lang('disc') ?></option>
							<option
								value="2>"><?= lang('biblical') ?></option>
						</select>
					</td>
					<td class="border">
						<input
		...
		<div
			...
			<div
				...
				<div
					...
					<h6 class="text-white modal-title dar"><?= lang('brake') ?></h6>
				</div>
				<div
					class="modal-body">
					<table
	...
	$(document).on('click', '.ex_9_add_new_tr', function (e) {
		...
		$.when(
			$('.ex_9').append('<tr role="row">\n' +
				...
				'</td>' +
				'<td class="border">\n' +
				'\t<select class="form-control selectpicker" data-size="5" name="brake_type[' + j + ']" title="<?=lang('type_disc_biblical')?>">\n' +
				'<option value="1"><?=lang('disc')?></option>\n' +
				'<option value="2>"><?=lang('biblical')?></option>\n' +
				'\t</select>\n' +
				'</td>\n' +
				'<td class="border">\n' +
