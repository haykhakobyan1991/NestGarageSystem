				...
				if ($fleet_data) {
					foreach ($fleet_data as $row) {
						...
						<tr style="height: 40px;">
							...
							<td class="border">
								<input class="form-control text-center" title="" type="text" disabled
									   name="accident_vehicle[<?= $row['id'] ?>]" value="<?= $row['brand_model'] ?>">
								<span style="display: none"><?= $row['brand_model'] ?></span>
							</td>
							<td class="border">
								<input class="form-control text-center" title="" type="date" disabled
									   name="accident_date[<?= $row['id'] ?>]" value="<?= $row['add_date'] ?>">
								<span style="display: none"><?= $row['add_date'] ?></span>
							</td>

							<td class="border">
								<input disabled title="" type="text"
									   name="accident_insurance_company[<?= $row['id'] ?>]"
							...
							<td class="border" style="min-width: 150px;">
								<select disabled class="form-control selectpicker" data-size="5"
										name="accident_staff_id[<?= $row['id'] ?>]" title="<?= lang('driver') ?>">
							...
							<td class="border">
								<input disabled title="" type="text"
									   name="accident_conclusion_number[<?= $row['id'] ?>]"
									   value="<?= $row['conclusion_number'] ?>"
									   class="form-control text-center"/>
							...
							<td class="border">
								<input disabled title="" type="text"
									   name="accident_replacement_parts[<?= $row['id'] ?>]"
									   value="<?= $row['replacement_parts'] ?>"
									   class="form-control text-center"/>
								<span style="display: none"><?= $row['replacement_parts'] ?></span>

							</td>
							<td class="border">
								<input disabled title="" type="text" name="accident_return_amount[<?= $row['id'] ?>]"
							...
							<td class="border" style="min-width: 150px;">
								<label style="font-size: 14px !important;line-height: 14px !important;padding: 10px 24px !important;font-weight: 500 !important;float: left;width: 85%;"
									class="btn btn-sm btn-outline-secondary mb-0">
									<span><?= lang('browse') ?></span>
									<input disabled id="accident_file_<?= $row['id'] ?>" type="file" name="accident_file_<?= $row['id'] ?>" class="d-none form-control-file btn_input" hidden
										   style="display: none;" id="exampleFormControlFile1">
								</label>


<!--								<input style="width: 90%" disabled value="" title="" type="file" min="0"-->
<!--									   name="accident_file_--><?//= $row['id'] ?><!--"-->
				...
				<tr>
					...
					<td class="border">
						<label
							...
							class="btn btn-sm btn-outline-secondary mb-0">
							<span><?= lang('browse') ?></span>
							<input type="file" name="accident_file_1" class="d-none form-control-file btn_input"
							hidden
							style="display: none;" id="exampleFormControlFile1">
						</label>
							...
							<tr class="">
								...
								<td class="border">
									<label
										...
										class="btn btn-sm btn-outline-secondary mb-0">
										<span><?= lang('browse') ?></span>
										<input type="file" name="accident_file_<?= $key + 1 ?>"
											   class="d-none form-control-file btn_input" hidden
											   style="display: none;" id="exampleFormControlFile1">
									</label>


									<!--									<input  value="" title="" type="file" min="0" name="accident_file_-->
									<? //= $key + 1 ?><!--"-->
									<!--											class="form-control text-center"/>-->
								</td>
							</tr>
	...
	$(document).on('click', '.ex_4_add_new_tr', function (e) {
		...
		$.when(
			$('.ex_4').append('<tr role="row">\n' +
				...
				'<span><?= lang("browse") ?></span>' +
				'<input type="file" name="accident_file_' + j + '" class="d-none form-control-file btn_input" hidden style="display: none;" id="exampleFormControlFile1">' +
				'</label>' +
				'</td>\n' +
