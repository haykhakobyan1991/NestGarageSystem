			...
			<tr>
				...
				<th class="">
					...
					<span data-toggle="modal"
						  ...
						  class=" btn btn-outline-secondary btn-sm " data-id="ex_10"
						  style="padding: .25rem .5rem !important;">
				<? } else { ?>
						<span class="ex_10_add_new_tr btn btn-outline-secondary btn-sm " data-id="ex_10"
							  style="padding: .25rem .5rem !important;">
				<? } ?>
...
<div class="pos_abs_div fixed-bottom text-left pb-2 mt-md-2 mt-2">
	<span id="grease" class="save_cancel_btn btn btn-success"><?= lang('save') ?></span>
...
<!--   Modal Start -->
<form id="vehicle_grease_modal">
	<div class="modal fade " tabindex="-1" role="dialog" id="vehicle_grease_m"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="modal-footer pb-0">
						<button id="vehicle_grease_add" type="button"
