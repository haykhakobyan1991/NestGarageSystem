	...
	<div class="container-fluid">
		<table id="ex_9" class="table table-striped table-borderless w-100">
			...
			<tr>
				...
				<th class="table_th" style="min-width: 150px;"><?=lang('type_disc_biblical')?></th>
			...
			<tr>
				...
				<td class="border">
					<select class="form-control selectpicker" data-size="5" name="brake_type[1]" title="<?=lang('type_disc_biblical')?>">
					...
					<table id="ex_9" class="table table-striped table-borderless w-100">
						...
						<? foreach ($fleet['name'] as $key => $name) { ?>
							<tr class="">
								...
								<td class="border">
									<select class="form-control selectpicker" data-size="5" name="brake_type[<?= $key + 1 ?>]" title="<?=lang('type_disc_biblical')?>">
										<option value="1"><?=lang('disc')?></option>
										<option value="2>"><?=lang('biblical')?></option>
									</select>
								</td>
