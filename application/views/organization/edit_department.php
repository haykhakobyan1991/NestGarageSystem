<form id="department_edit">
	...
	<div class="form-group row mb-0 mt-1">
		...
		<div class="col-sm-8">
			<select name="head_staff" id="model_select" class="form-control selectpicker" data-size="5" id="head_staff"
					data-live-search="true" title="<?= lang('select_staff') ?>">
	...
	<div class="form-group row mb-2" style="margin-top: 0.4em;">
		...
		<div class="col-sm-8">
			<textarea rows="3" value="" type="text" class=" form-control" name="description"
					  placeholder="<?= lang('more_info') ?>"><?= $description ?></textarea>
		</div>
	</div>
