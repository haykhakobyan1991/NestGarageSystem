	...
	<div
					...
					<div
						...
						<div
							...
							<p class="display-5 font-weight-bold float-left"
							   style="font-size: 13px;"><?= lang('total_vehicles') ?></p>
							<span
		...
		<div
			...
			<div
				...
				<div
					class="row col-sm-12 col-md-12 ml-0 mr-0"
...
color: #545b62;">
						...
						<? foreach ($result_array as $row) : ?>
							<tr>
								...
								<td>
									<span
										style="display: none">Spitak</span><span
										class="p-3 m-2 text-white"
