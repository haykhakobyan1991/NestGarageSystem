		...
		<table id="ex_1" class="table table-striped table-borderless w-100">
			...
			if (count($fleet['id']) == 1) { ?>
				<tr>
					...
					<td class="border">
						<input title="" readonly type="text" name="date[1]" value="<?= mdate('%Y-%m-%d', now()) ?>"
							   class="form-control text-center"/>
					</td>
					<td class="border">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group row mb-0">
						...
						<label class="col-sm-4 col-form-label">Վերջնաժամկետ *</label>
						<div class="col-sm-7">
					...
					<div class="form-group row mb-0 mt-1">
						...
						<div class="col-sm-7">
							<input type="text" name="price" placeholder="Գումար" class="form-control">
						</div>
					</div>
