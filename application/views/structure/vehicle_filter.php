		...
		<div class="modal-dialog" style="max-width: 80%;">
			<div class="modal-content">
				<div class="modal-header bg-dark">
					<h6 class="text-white modal-title dar">ՖԻԼՏՐ</h6>
...
<script>
	...
	ajax('form#vehicle_filter', 'span#filter');

	ajax('form#vehicle_filter_modal', '#vehicle_filter_add');

	function ajax(form, button) {

		$(document).on('click', button, function (e) {
			var url = '<?=base_url($this->uri->segment(1) . '/Structure/filter_ax') ?>';
			var me = $(this);
			e.preventDefault();
