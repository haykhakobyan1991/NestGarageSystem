...
<div
	...
	<div
		...
		<div
			...
			<button
				class="btn btn-sm btn-outline-secondary plus_btn mr-3"
				data-toggle="modal"
			...
			<button
				class="btn btn-sm btn-outline-secondary set_btn mr-3"
				id="edit_group_modal"
				data-toggle="modal"
					...
					<form
						...
						<div
							...
							<div
								class="col-sm-1"></div>
							<label
								class="col-sm-2 col-form-label"><?= lang('company_name') ?></label>
							<div
								class="col-sm-8">
								<input
									name="title"
						...
						<div
							...
							<div
								class="col-sm-1"></div>
							<label
								class="col-sm-2 col-form-label"><?= lang('more_info') ?></label>
							<div
								class="col-sm-8">
							<textarea
								name="description"
